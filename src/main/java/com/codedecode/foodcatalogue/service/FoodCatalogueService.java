...
public class FoodCatalogueService {
    ...
    public FoodCataloguePage  fetchFoodCatalougePageDetail(Integer restaurantId) {
        List<FoodItem> foodItemList = fetchFoodItemList(restaurantId);
        Restaurant restaurant = fetchRestaurantDetailsFromRestaurantMS(restaurantId);
        return creatFoodCataloguePage(foodItemList, restaurant);
    }

    private FoodCataloguePage creatFoodCataloguePage(List<FoodItem> foodItemList, Restaurant restaurant) {
